...
<!-- Spells Known -->
    ...
    <div id="featuresAndTraits">
      ...
      <div id="speciesFeatures" class="feature-item">
        <div class="feature-title" id="speciesTitle">â€”</div>
      ...
      <div id="featsSection">
        <div class="feature-item">
          ...
          <div class="feature-description">
            <div><strong>Background:</strong> <span id="featBgName">â€”</span></div>
            <div><strong>Origin Feat:</strong> <span id="originFeatName">â€”</span></div>
